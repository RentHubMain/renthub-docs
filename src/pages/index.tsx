      ...
      <div className={styles.heroInner}>
        <div className={styles.heroLeft}>
          ...
          <p className={styles.heroLead}>
            ...
            B2B/C2C 租赁（当前以 C2C 为主），依托微信小程序与
            Monorepo（小程序、云函数、管理后台、官网）。
          </p>
    ...
    <div className={styles.sectionInner}>
      <div className={styles.sectionHeader}>
        ...
        <p className={styles.sectionSub}>
          建议按序阅读：先跟快速上手指南走通环境与第一次 PR；再用 Cursor 建立 AI 协作习惯，接着读
          Git 基础与团队工作流；随后是 CI、RentHub 业务仓流程，以及微信与
          CloudBase。完整目录见侧栏与各板块首页。
        </p>
      </div>
      ...
      <p className={styles.quickStartFoot}>
        做界面与视觉规范时另读 <Link to="/docs/ui-design/">界面设计</Link> ；需要巩固现代 JS 时可读{" "}
        <Link to="/docs/dev-knowledge/js-es6">JavaScript ES6+</Link> ；版本管理与工作流其余文档见{" "}
        <Link to="/docs/project-mgmt/">板块索引</Link> ；开发知识见{" "}
      ...
      <div className={styles.beyondLayout}>
        <div className={styles.beyondText}>
          ...
          <p className={styles.beyondDesc}>
            本站以 RentHub 业务为背景编写，其中大量内容对<strong>不同角色的读者</strong>
            都有参考价值。
